export const sourceText = {
  ...
  'JWT 解码': 'JWT Decoder',
  '🔑 JWT 解码': 'JWT Decoder',
  'JWT 编解码': 'JWT Encode/Decode',
  '🔑 JWT 编解码': 'JWT Encode/Decode',
  '编码 / HS256 签名': 'Encode / HS256 sign',
  '解码此 Token': 'Decode this token',
  '自动补齐 iat / exp': 'Fill iat / exp automatically',
  '签名生成': 'Sign token',
  '🔐 签名生成': 'Sign token',
  'HMAC': 'HMAC',
  '🔏 HMAC': 'HMAC',
  ...
  '📋 复制 HTML': 'Copy HTML',
  '预览': 'Preview',
  '假数据生成': 'Fake Data Generator',
  '🎲 假数据生成': 'Fake Data Generator',
  '📋 复制全部': 'Copy all',
  '📋 复制 JSON': 'Copy JSON',
  '权限计算': 'chmod Calculator',
  '🔐 权限计算': 'chmod Calculator',
  '八进制': 'Octal',
  '符号': 'Symbolic',
  '重置 755': 'Reset 755',
...
export const sourceAttributes = {
  ...
  '输入 HMAC 密钥...': 'Enter HMAC secret...',
  '输入要签名的文本...': 'Enter text to sign...',
  '输入签名密钥...': 'Enter signing secret...',
  '输入 Markdown...': 'Enter Markdown...',
  '输入 camelCase、snake_case、kebab-case 或普通文本...': 'Enter camelCase, snake_case, kebab-case, or plain text...',
  '输入 5 或 6 段 Cron 表达式，例如 */5 * * * *': 'Enter a 5- or 6-field cron expression, such as */5 * * * *',
