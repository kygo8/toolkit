...
export const toolCatalog = {
  ...
  hmac: { path: '/codec/hmac', icon: '🔏', color: '#f43f5e', category: 'codec' },
  ...
  caseConvert: { path: '/dev/case', icon: 'Aa', color: '#8b5cf6', category: 'dev' },
  cron: { path: '/dev/cron', icon: '⏱', color: '#f97316', category: 'dev' },
  timezone: { path: '/dev/timezone', icon: '🌍', color: '#06b6d4', category: 'dev' },
  markdown: { path: '/dev/markdown', icon: 'MD', color: '#22c55e', category: 'dev' },
  fakeData: { path: '/dev/fake-data', icon: '🎲', color: '#a78bfa', category: 'dev' },
  chmod: { path: '/dev/chmod', icon: '🔐', color: '#64748b', category: 'dev' },
...
export const categoryCatalog = {
  ...
  dev: { path: '/dev', icon: '🛠️', color: '#00d9ff', tools: ['timestamp', 'color', 'regex', 'numberBase', 'uuid', 'textDiff', 'caseConvert', 'cron', 'timezone', 'markdown', 'fakeData', 'chmod'] },
