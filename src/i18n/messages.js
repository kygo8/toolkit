...
const en = {
  ...
  categories: {
    ...
    dev: { title: 'Developer Tools', eyebrow: 'Developer Toolkit', desc: 'Timestamp, color, regex, number base, UUID, text diff, case convert, cron, timezone, Markdown, fake data and chmod utilities.' },
...
const zhCN = {
  ...
  categories: {
    ...
    dev: { title: '开发者工具', eyebrow: 'Developer Toolkit', desc: '时间戳、颜色、正则、进制、UUID、文本对比、大小写、Cron、时区、Markdown、假数据和权限计算等开发辅助工具。' },
