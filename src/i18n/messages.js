...
const en = {
  ...
  categories: {
    ...
    dev: { title: 'Developer Tools', eyebrow: 'Developer Toolkit', desc: 'Timestamp, color, regex, UUID, text diff, and JSON/YAML/XML/CSV/TOML/SQL/code formatting utilities.' },
...
const zhCN = {
  ...
  categories: {
    ...
    dev: { title: '开发者工具', eyebrow: 'Developer Toolkit', desc: '时间戳、颜色、正则、进制、UUID、文本对比，以及 JSON/YAML/XML/CSV/TOML/SQL 和代码格式化等开发辅助工具。' },
